        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 px-5">
            <div class="md:flex md:items-center md:justify-between">
                <div class="flex-1 min-w-0">
                    <h1 class="py-0.5 text-2xl font-semibold text-gray-900">{{ $t('Respuestas preconfiguradas') }}</h1>
                </div>
                        ...
                        <div class="flex rounded-md shadow-sm">
                            ...
                            <div class="relative inline-flex shadow-sm rounded-r-md">
                                ...
                                >
                                    ...
                                    <option value="shared">{{ $t('Compartido') }}</option>
                                    <option value="user_id">{{ $t('Usuario') }}</option>
                                            ...
                                            <div class="min-w-0 flex-1 r-4 lg:grid lg:grid-cols-2 lg:gap-4">
                                                <div>
                                                    ...
                                                    >
                                                        ...
                                                        {{ $t('La respuesta esta compartida') }}
                                                    </div>
                                                    <div
                                                        v-show="!cannedReply.shared"
                                                    ...
                                                    >
                                                        ...
                                                        {{ $t('la respuesta no esta compartida') }}
                                                    </div>
                                                </div>
