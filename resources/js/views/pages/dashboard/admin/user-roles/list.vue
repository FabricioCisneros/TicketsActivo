        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 px-5">
            <div class="md:flex md:items-center md:justify-between">
                <div class="flex-1 min-w-0">
                    <h1 class="py-0.5 text-2xl font-semibold text-gray-900">{{ $t('Roles de usuario') }}</h1>
                </div>
                        ...
                        <div class="m-auto">
                            <div class="grid grid-cols-1 justify-items-center h-full w-full px-4 py-10">
                                ...
                                <template v-if="search">
                                    <div class="flex justify-center items-center">
                                        <div>{{ $t('Trata de cambiar los filtros o revisa que tu busqueda este bien escrita') }}</div>
                                    </div>
                                </template>
                            </div>
                        </div>
