            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 px-5">
                <div class="md:flex md:items-center md:justify-between">
                    <div class="flex-1 min-w-0">
                        <h1 class="py-0.5 text-2xl font-semibold text-gray-900">{{ $t('Editar rol de usuario') }}</h1>
                    </div>
                ...
                <div class="mt-6 shadow sm:rounded-lg">
                    ...
                    <div class="bg-white md:grid md:grid-cols-3 md:gap-6 px-4 py-5 sm:p-6">
                        <div class="md:col-span-1">
                            <h3 class="text-lg font-medium leading-6 text-gray-900">{{ $t('Informacion de rol') }}</h3>
                            <p class="mt-1 text-sm leading-5 text-gray-500">
                                {{ $t('Esta informacion será mostrada publicamente') }}.
                            </p>
                        </div>
                                ...
                                <div class="col-span-3">
                                    ...
                                    <div class="mt-1 flex rounded-md">
                                        <input-switch
                                            ...
                                            :disabled-label="$t('Los usuarios no tendran acceso al dashboard')"
                                            :enabled-label="$t('Los usuarios tienen acceso al dashaboard')"
                                        ></input-switch>
                                    </div>
