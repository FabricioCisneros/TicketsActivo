        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 px-5">
            <div class="md:flex md:items-center md:justify-between">
                <div class="flex-1 min-w-0">
                    <h1 class="py-0.5 text-2xl font-semibold text-gray-900">{{ $t('Departamentos') }}</h1>
                </div>
                                        ...
                                        <div class="min-w-0 flex-1 sm:flex sm:items-center sm:justify-between">
                                            <div>
                                                ...
                                                >
                                                    ...
                                                    {{ $t('El departamento no es publico') }}
                                                </div>
                                            </div>
                                            <div class="mt-4 flex-shrink-0 sm:mt-0">
                                                <div class="flex overflow-hidden">
                                                    ...
                                                    <template v-else-if="department.all_agents && department.agents.length === 0">
                                                        <div class="text-sm text-gray-700">
                                                            {{ $t('No hay usuarios pertenecientes a este departamento') }}
                                                        </div>
                                                    </template>
                                                    <template v-else>
...
export default {
    ...
    metaInfo() {
        return {
            title: this.$i18n.t('Departamentos')
        }
    },
    data() {
        return {
