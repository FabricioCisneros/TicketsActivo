            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 px-5">
                <div class="md:flex md:items-center md:justify-between">
                    <div class="flex-1 min-w-0">
                        <h1 class="py-0.5 text-2xl font-semibold text-gray-900">{{ $t('Editar Departamento') }}</h1>
                    </div>
                ...
                <div class="mt-6 shadow sm:rounded-lg">
                    ...
                    <div class="bg-white md:grid md:grid-cols-3 md:gap-6 px-4 py-5 sm:p-6">
                        <div class="md:col-span-1">
                            <h3 class="text-lg font-medium leading-6 text-gray-900">{{ $t('Informacion de departamento') }}</h3>
                            <p class="mt-1 text-sm leading-5 text-gray-500">
                                {{ $t('Detalles y opciones del departamento') }}.
                            </p>
                        </div>
                            ...
                            <div class="grid grid-cols-3 gap-6">
                                ...
                                <div class="col-span-3">
                                    ...
                                    <input-switch
                                        ...
                                        :disabled-label="$t('Solo a los usuarios seleccionados')"
                                        :enabled-label="$t('todos los usuarios')"
                                    ></input-switch>
                                    <div class="mt-2 relative text-xs text-gray-500">
                                        {{ $t('Permite el acceso al departamento a todos los agentes, o exclusivamente a un grupo específico de agentes.') }}.
                                    </div>
                                </div>
                                <div class="col-span-3">
                                    <label class="block text-sm font-medium leading-5 text-gray-700" for="public">{{ $t('visibilidad') }}</label>
                                    <input-switch
                                        id="public"
                                    ...
                                    ></input-switch>
                                    <div class="mt-2 relative text-xs text-gray-500">
                                        {{ $t('Si el departamento es público, permite a los usuarios seleccionar este departamento al crear el ticket, de lo contrario solo los agentes pueden reasignarlo a este departamento.') }}.
                                    </div>
                                </div>
                            </div>
                        </div>
                        <template v-if="!department.all_agents">
                            ...
                            <div class="md:col-span-1">
                                <h3 class="text-lg font-medium leading-6 text-gray-900">{{ $t('Usuarios del departamento') }}</h3>
                                <p class="mt-1 text-sm leading-5 text-gray-500">
                                    {{ $t('Lista de todos los agentes asignados a este departamento') }}.
                                </p>
                            </div>
                            <div class="mt-5 md:mt-0 md:col-span-2">
                                <div class="grid grid-cols-3 gap-6">
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    <div class="mt-2">
                                        <p class="text-sm leading-5 text-gray-500">
                                            {{ $t('Estas seguro de eliminar este departamento?') }}
                                            {{ $t('Todos los datos pertenecientes y vinculados a el se eliminaran') }}.
                                            {{ $t('Los tickets asigandos a ese departamento se mostraran con la leyenda "sin departamento"') }}.
                                            {{ $t('Estas accion no podra reevertirse') }}.
                                        </p>
                                    </div>
                                </div>
                            </div>
...
export default {
    ...
    metaInfo() {
        return {
            title: this.$i18n.t('Modificacion del departamento')
        }
    },
    data() {
        return {
