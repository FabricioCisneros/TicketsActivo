                            ...
                            <div class="flex rounded-md shadow-sm">
                                ...
                                <div class="relative inline-flex rounded-none">
                                    <select
                                        ...
                                        @change="getTickets"
                                    >
                                        <option :value="null">{{ $t('Todos los tickets') }}</option>
                                ...
                                <div class="relative inline-flex rounded-r-md">
                                    ...
                                    >
                                        ...
                                        <option value="status_id">{{ $t('Estatus del ticket') }}</option>
                        ...
                        <div class="h-full flex">
                            <div class="m-auto">
                                <div class="grid grid-cols-1 justify-items-center h-full w-full py-24">
                                    ...
                                    <div class="flex justify-center items-center">
                                        <div class="w-full font-semibold text-2xl">{{ $t('No se encontraron resultados') }}</div>
                                    </div>
                                    <template v-if="anyFilter">
                                        <div class="flex justify-center items-center">
                                            <div>{{ $t('Intenta cambiar tus filtros de busqueda o revisa que tu busqueda este bien escrita') }}.</div>
                                        </div>
                                    </template>
                                </div>
                            </div>
