                ...
                <div class="md:flex md:items-center md:justify-between">
                    ...
                    <div class="mt-4 flex md:mt-0 md:ml-4">
                        <router-link
                            ...
                            to="/tickets/list"
                        >
                            {{ $t('Regresar a la lista de mis tickets') }}
                        </router-link>
                    </div>
                </div>
            </div>
                            ...
                            <div class="md:col-span-2">
                                <div class="grid grid-cols-3 gap-6">
                                    <div class="col-span-3">
                                        <label class="block text-sm font-medium leading-5 text-gray-700" for="subject">{{ $t('Asunto del ticket') }}</label>
                                        <div class="mt-1 relative rounded-md shadow-sm">
                                            <input
                                                id="subject"
                                                v-model="ticket.subject"
                                                :placeholder="$t('Asunto de ticket')"
                                    ...
                                    <div v-if="departmentList.length > 0" class="col-span-3">
                                        <label class="block text-sm font-medium leading-5 text-gray-700" for="department">{{ $t('Departamento a asignar') }}</label>
                                        <div class="mt-1 relative rounded-md shadow-sm">
                                            <input-select
                                                id="department"
